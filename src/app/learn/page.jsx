...
export default function Home() {
    ...
    if (navigator && navigator.userAgent.includes("Chrome")) return (
        ...
        </main>); else return <Typography variant={"h1"}>PLEASE USE CHROME AS <a
        href="https://developer.mozilla.org/en-US/docs/Web/API/Web_Speech_API">WEBSPEECH API</a> MOSTLY WORKS ON CHROME
                                                         ONLY </Typography>
}